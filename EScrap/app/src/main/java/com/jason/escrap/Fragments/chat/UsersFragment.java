...
import com.jason.escrap.Activity.ChatActivity;
import com.jason.escrap.Adapter.UserListingRecyclerAdapter;
import com.jason.escrap.Fragments.chat.users.getall.GetUsersContract;
import com.jason.escrap.Fragments.chat.users.getall.GetUsersPresenter;
import com.jason.escrap.Model.Users;
import com.jason.escrap.R;
import com.jason.escrap.Utils.ItemClickSupport;
...
public class UsersFragment extends Fragment implements GetUsersContract.View, ItemClickSupport.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onItemClicked(RecyclerView recyclerView, int position, View v) {
        ChatActivity.startActivity(getActivity(),
                ...
                "",mUserListingRecyclerAdapter.getUser(position).getName());
    }
    ...
    @Override
    public void onGetChatUsersSuccess(List<Users> users) {
